...
class OnSceneScreen extends StatefulWidget {
  final Task? task;
  const OnSceneScreen({Key? key, this.task}) : super(key: key);

  @override
  _OnSceneScreenState createState() => _OnSceneScreenState();
}

class _OnSceneScreenState extends State<OnSceneScreen> {
                  ...
                  child: MaterialButton(
                    onPressed: () {
                      showDialog(
                        ...
                        builder: (_) => AlertDialog(
                          title:
                              Text('ODO Reading', style: GoogleFonts.inter()),
                          titlePadding:
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FormBuilderTextField(
                                  ...
                                  validator: (val) {
                                    if (val!.isEmpty) {
                                      return 'You must hospital address';
                                    }
                                    return null;
                                  },
                                ),
                            ...
                            ElevatedButton(
                              onPressed: () {
                                ...
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  _dbServices.updateStatusToDepartsScene(
                                    context: context,
                                    task: widget.task,
