...
class DepartedScreen extends StatefulWidget {
  final Task? task;
  DepartedScreen({Key? key, this.task}) : super(key: key);

  @override
  _DepartedScreenState createState() => _DepartedScreenState();
}

class _DepartedScreenState extends State<DepartedScreen> {
                ...
                Padding(
                  ...
                  child: MaterialButton(
                    onPressed: () {
                      ...
                      _dbServices.updateStatusToArrivesHospital(
                        context: context,
                        task: widget.task,
