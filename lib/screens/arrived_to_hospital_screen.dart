...
class ArriveToHospitalScreen extends StatefulWidget {
  final Task? task;
  const ArriveToHospitalScreen({Key? key, this.task}) : super(key: key);

  @override
  _ArriveToHospitalScreenState createState() => _ArriveToHospitalScreenState();
}

class _ArriveToHospitalScreenState extends State<ArriveToHospitalScreen> {
                  ...
                  child: MaterialButton(
                    onPressed: () {
                      ...
                      String _formattedActionTime =
                          DateFormat('yyyy-MM-ddThh:mm:ss').format(time);
                      _dbServices.updateStatusToHandOver(
                        context: context,
                        task: widget.task,
                        parent: widget.task!.id.toString(),
                        forCrew: widget.task!.forCrew!.id.toString(),
                        medicLoc: response.medicLoc,
                        targetLoc: response.targetLoc,
