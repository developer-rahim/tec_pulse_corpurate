...
class ResponseDetailsScreen extends StatefulWidget {
  final Task? task;
  const ResponseDetailsScreen({Key? key, this.task}) : super(key: key);

  @override
  _ResponseDetailsScreenState createState() => _ResponseDetailsScreenState();
}
      ...
      body: FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
          if (snapshot.hasData) {
            ...
            // _getDirectionsInfo(response.medicLoc, response.targetLoc);
            return ListView(
              children: [
                            ...
                            ElevatedButton(
                              onPressed: () {
                                ...
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  _dbServices.updateStatusToOnScene(
                                    context: context,
                                    task: widget.task,
